              ...
              <div class="col-sm-12 col-md-12">
                <div class="card">
                    <div class="card-header">
                      <i class="fa fa-align-justify"></i>{{ __('Lista de Usuarios') }}
                      @role('admin')
                        ...
                        <tbody>
                          @foreach($users as $user)
                            <tr>
                              ...
                              @endif
                              <td>
                                <a href="{{ url('/users/' . $user->id) }}" class="btn btn-block btn-outline-primary">Ver</a>
                              </td>
                              <td>
                                <a href="{{ url('/users/' . $user->id . '/edit') }}" class="btn btn-outline-warning">Editar</a>
                              </td>
                            </tr>
                          @endforeach
                        </tbody>
