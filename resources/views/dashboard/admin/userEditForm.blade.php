                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="/users/{{ $user->id }}">
                            ...
                            <button class="btn btn-block btn-success" type="submit">{{ __('Actualizar') }}</button>
                            
                        </form>
                        <hr>
                        <form method="POST" action="/users/{{ $user->id }}">
                            <button class="btn btn-block btn-success" type="submit">{{ __('Resetear Contraseña') }}</button>
                        </form>
                        <hr>
