              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-xl-2 col-md-3 col-sm-4 col-6 mb-4">
                      <div class="bg-group-1 theme-color w-75 rounded mb-2" style="padding-top:75%"></div>
                      <h6>Grupo Vinotinto</h6>
                    </div>
                    <div class="col-xl-2 col-md-3 col-sm-4 col-6 mb-4">
                      <div class="bg-group-2 theme-color w-75 rounded mb-2" style="padding-top:75%"></div>
                      <h6>Grupo Rojo</h6>
                    </div>
                    <div class="col-xl-2 col-md-3 col-sm-4 col-6 mb-4">
                      <div class="bg-group-3 theme-color w-75 rounded mb-2" style="padding-top:75%"></div>
                      <h6>Grupo Naranja</h6>
                    </div>
                    <div class="col-xl-2 col-md-3 col-sm-4 col-6 mb-4">
                      <div class="bg-group-4 theme-color w-75 rounded mb-2" style="padding-top:75%"></div>
                      <h6>Grupo Amarillo</h6>
                    </div>
                    <div class="col-xl-2 col-md-3 col-sm-4 col-6 mb-4">
                      <div class="bg-group-5 theme-color w-75 rounded mb-2" style="padding-top:75%"></div>
                      <h6>Grupo Verde</h6>
                    </div>
                  </div>
                </div>
