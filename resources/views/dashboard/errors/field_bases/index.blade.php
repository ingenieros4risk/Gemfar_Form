              ...
              <div class="col-sm-12 col-md-12">
                <div class="card">
                    <div class="card-header">
                      <i class="fa fa-align-justify"></i>{{ __('Lista de Criterios de Bases') }}</div>
                    <div class="card-body">
                        <table class="table table-striped table-bordered" id="bases-table">
                        <thead>
                          <tr>
                            <th>Nombre</th>
                            <th>Peso</th>
                        ...
                        <tbody>
                          @foreach($evaluatedfield as $value)
                            <tr>
                              <td>{{ $value->name }}</td>
                              <td>{{ $value->weight }}</td>
                            </tr>
