              ...
              <div class="col-sm-12 col-md-12">
                <div class="card">
                    <div class="card-header">
                      <i class="fa fa-align-justify"></i>{{ __('Listado Opciones Pregunta Conferiencias') }}</div>
                    <div class="card-body">
                        <table class="table table-striped table-bordered" id="conferences-table">
                        <thead>
                          <tr>
                            <th>Nombre</th>
                            <th>Score</th>
                        ...
                        <tbody>
                          @foreach($conferences as $country)
                            <tr>
                              <td>{{ $country->name}}</td>
                              <td>{{ $country->score}}</td>
                              <td>
