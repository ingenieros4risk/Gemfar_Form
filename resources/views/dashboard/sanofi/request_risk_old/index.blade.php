                ...
                <div class="card">
                    <div class="card-header">
                      ...
                      <button class="btn btn-outline-success cc_pointer float-right" type="button">
                        <a href="{{ url('/sanofi-request-risk/create') }}">
                          <svg class="c-icon">
                    ...
                    <div class="card-body">
                        <table class="table table-striped table-bordered" id="requests_risk-table">
                        <thead>
                          <tr>
                            <th>id</th>
                            <th>Ver</th>
                        ...
                        <tbody>
                          @foreach($requests_risk as $value)
                            <tr>
                              <td>{{ $value->id}}</td>
                              <td>
                                <a href="{{ url('/sanofi-old/' . $value->id) }}" class="btn btn-block btn-primary">Ver</a>
                              </td>
