...
# NOTIFICACIÓN ALERTA FORMULARIO HYS {{$data['id_task']}}

Estimados usuarios, se ha generado esta notificación porque el proveedor activó una alerta al formulario HYS.
